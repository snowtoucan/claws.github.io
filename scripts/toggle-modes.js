...
// Check if mode is stored in local storage and set it
...
if (storedMode === 'dark-mode') {
  ...
  // Default to light mode if no mode is stored and system prefers light mode
  document.body.classList.add('light-mode');
}

// Add event listener to the mode toggle button or element
var toggleButton = document.getElementById('mode-toggle-button');
