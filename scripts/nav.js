...
navContainer.innerHTML = `
        <div class="head-left">
            <a id = "indexLink" href=${ artistView ? "../index.html" : "index.html" }>
                    <li class="li-head">
                ...
                <div class="menu-container">
                    <div class="menu-wrapper">
                        ...
                        <div class="submenu about-submenu">
                            <li>
                                <a id = 'artistsLink' href=${ artistView ? "#" : "./artists/harmtails.html" }>
                                    <h2>artists</h2>
                                </a>
                            </li>
                            <li>
                        ...
                        <li class="li-head menu">
                            <a id = 'eventsLink' href="events.html"><h2  class="noselect">events</h2></a>
                        </li>
                    </div>
                </div>
                <li> 
                    <a href="#" id="mode-toggle-button">
                        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1000 1000' class="toggle-themes">
                            <path d="M709.08,692.93c-222.02,0-402.01-179.99-402.01-402.01,0-114.44,47.82-217.73,124.56-290.92C187.67,34.43,0,244.04,0,497.5c0,277.53,224.98,502.5,502.5,502.5,253.46,0,463.07-187.67,497.5-431.63-73.19,76.74-176.48,124.56-290.92,124.56h0Z"/>
                        </svg>
                    </a>
                </li>   
            </div>
